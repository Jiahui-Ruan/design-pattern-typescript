...
function formatQuestion(quizQuestion: QuizQuestion) {
    ...
    console.log(quizQuestion.answer1, quizQuestion.answer2, quizQuestion.answer3, quizQuestion.answer4);
}

let quizQuestion = new QuizQuestion("Which framework is using Typescript", "React", "Vue", "Angualr", "Cycle", 3);
